...
<body class="defult-home">
                    ...
                    @if (isset($images))
                        ...
                        @foreach ($images as $image)
                            <div class="mySlides">
                                ...
                                <img src="{{ asset('uploads/projects/' . $details[0]->title . '/' . $image->getFilename()) }}"
                                    class="demo cursor" style="width:700px;height: 500px;" onclick="currentSlide(1)"
                                    alt="The Woods">
                            </div>
                        @endforeach
                    @endif
    ...
    <footer id="rs-footer" class="rs-footer home9-style home12-style">@include('/frontend.partials.footer')</footer>
