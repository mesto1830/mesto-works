    ...
    <div id="panel-1" class="panel">
        <div  class="custom-toolbar">
            ...
            <div class="panel-toolbar">
              <a href="{{route('products.create')}}" class="btn btn-success waves-effect waves-themed">Yeni Ürün Ekle</a>
            </div>
        </div>
                      ...
                      @if($products)
                        @foreach($products as $item)
                          <tr>
                            ...
                            <td><img src="{{asset($item->imagedetail)}}" alt="" width=48></td>
                            <td>
                                <a href="{{route('products.edit', $item->id)}}" style="color:#fff;" class="btn btn-success waves-effect waves-themed">Düzenle</a>
