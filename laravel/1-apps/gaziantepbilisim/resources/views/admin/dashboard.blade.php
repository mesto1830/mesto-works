...
<html lang="tr">
        ...
        <link rel="mask-icon" href="{{asset('img/0/favicon.png')}}">
            ...
            <div class="page-inner">
                <aside class="page-sidebar">
                    <a href="{{route('admin.dashboard')}}">
                        <div class="page-logo">
                            <img src="{{asset('img/0/favicon.png')}}" aria-roledescription="logo">
                ...
                <div class="page-content-wrapper">
                    <header class="page-header" role="banner">
                        ...
                        <div class="ml-auto d-flex">
                            ...
                            <div>
                                <a href="#" data-toggle="dropdown" title="gaziantepbilisim.com.tr" class="header-icon d-flex align-items-center justify-content-center ml-2">
                    ...
                    <footer class="page-footer" role="contentinfo">
                        <div class="d-flex align-items-center flex-1 text-muted">
                            <span class="hidden-md-down fw-700"><a href='{{route('index')}}' class='text-primary fw-500' title='gaziantepbilisim' target='_blank'>gaziantepbilisim.com.tr</a></span>
                        </div>
