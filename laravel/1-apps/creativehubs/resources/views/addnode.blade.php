...
@section('content')
 <div class="container" style="padding:30px;">
    ...
    <div class="add-node-inputs-con">
      <input type="text" id="nodeSource2" class="node-inputs" placeholder="Düğüm Kaynagı 2...">
    </div>
    <div class="add-node-inputs-con">
      <input type="text" id="nodeSource3" class="node-inputs" placeholder="Düğüm Kaynagı 3...">
    </div>
    <div class="add-node-inputs-con">
