        ...
        style: [
          {
            ...
            style: {
              ...
              'label': 'data(id)',
              'font-family':'Cambria',
                fontSize: function(ele){ return Math.max(1, Math.ceil(ele.degree()/2)) * 4; },
                width: function(ele){ return Math.max(1, Math.ceil(ele.degree()/2)) * 4; },
                height: function(ele){ return Math.max(1, Math.ceil(ele.degree()/2)) * 4; },
            }
          },
