      ...
      <div class="main-set-list">
        <section class="user-id-section">
          ...
          <li class="set-li">
            ...
            <input v-model="setTime.kbs" type="text" min="0" max="24" class="inp set-inp" :input="setTime.kbs">
            <i v-if="done === 'kbs'" class="fa fa-thumbs-up fa-2x cl-g slbs"/>
            <i v-else class="fa fa-save fa-2x cl-f slbs" @click="updateSetTime('kbs', setTime.sa)"/>
            <span>Saniye Olarak</span>
          </li>
